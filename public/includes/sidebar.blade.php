...
<!--                </li>-->
                ...
                <li class="nav-item <?php echo $MODULO=="obras"?"active submenu":""?>">
                    <a data-toggle="collapse" href="#obras" <?php echo $MODULO=="obras"?"class aria-expanded='true'":""?>>
                ...
                <li class="nav-item <?php echo $MODULO=="funcionarios"?"active submenu":""?>">
                    <a data-toggle="collapse" href="#funcionarios" <?php echo $MODULO=="funcionarios"?"class aria-expanded='true'":""?>>
                ...
                <li class="nav-item <?php echo $MODULO=="clientes"?"active submenu":""?>">
                    <a data-toggle="collapse" href="#clientes" <?php echo $MODULO=="clientes"?"class aria-expanded='true'":""?>>
            ...
            <li class="nav-item <?php echo $MODULO=="materiais"?"active submenu":""?>">
                    <a data-toggle="collapse" href="#materiais" <?php echo $MODULO=="materiais"?"class aria-expanded='true'":""?>>
                        <i class="fas fa-tasks"></i>
                        <p>&nbsp;&nbsp;Materiais</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse <?php echo $MODULO=="materiais"?"show":""?>" id="materiais">
                        <ul class="nav nav-collapse">
                            <li <?php echo $MODULO=="materiais"&&$func=='listar'?"class='active'":""?>>
                                <a href="<?php echo route('home');?>">
                                    <span class="sub-item">Ver materiais</span>
                                </a>
                            </li>
                            <li <?php echo $MODULO=="materiais"&&$func=='criar'?"class='active'":""?>>
                                <a href="<?php echo route('home');?>">
                                    <span class="sub-item">Criar materiais</span>
                                </a>
                            </li>
                        </ul>
                    </div>
