                                        ...
                                        @foreach($obras as $obra)
                                            @if($obra->data_inicio != null && $obra->data_final == null)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a data-id="{{$obra->id}}" class="conclui" data-csrf="{{csrf_token()}}" data-rota="{{route('obras.concluir', ['obra'=>$obra->id])}}"><i
...
{{--        console.log($("input[type=hidden][name=_token]").val());--}}
{{--        $.ajax({--}}
{{--            url:'{{route('dashboard.color')}}',--}}
{{--            type:'post',--}}
{{--            data: {--}}
{{--                "cor" : $(this).data('color'),--}}
{{--                "tipo" : 'cor_header',--}}
{{--                "_token" : $("input[type=text][name=_token]").val()--}}
{{--            }--}}
{{--        })--}}
{{--    });--}}
