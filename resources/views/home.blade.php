                ...
                <div class="page-inner py-5">
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                        ...
                        <div class="ml-md-auto py-2 py-md-0">
                            <a href="{{route('home')}}/" class="btn btn-white btn-border btn-round mr-2">Manage</a>
                            <a href="{{route('home')}}/" class="btn btn-secondary btn-round">Add Customer</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-header">
                                <div class="card-head-row">
                                    ...
                                    <div class="card-tools">
                                        ...
                                        <a href="{{route('home')}}" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
                                        ...
                                        <div class="table-responsive table-hover table-sales">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/id.png"
                                                                 alt="indonesia">
                                                        </div>
                                                    </td>
                                                    <td>Indonesia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/us.png"
                                                                 alt="united states">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/au.png"
                                                                 alt="australia">
                                                        </div>
                                                    </td>
                                                    <td>Australia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/ru.png"
                                                                 alt="russia">
                                                        </div>
                                                    </td>
                                                    <td>Russia</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/cn.png"
                                                                 alt="china">
                                                        </div>
                                                    </td>
                                                    <td>China</td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="{{route('home')}}/assets/img/flags/br.png"
                                                                 alt="brazil">
                                                        </div>
                                                    </td>
                                                    <td>Brasil</td>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="{{route('home')}}/assets/img/logoproduct.svg" alt="..."
                                ...
                                <div class="d-flex">
                                    <div class="avatar">
                                        <img src="{{route('home')}}/assets/img/logoproduct3.svg" alt="..."
                                             class="avatar-img rounded-circle">
                                    </div>
                                    <div class="flex-1 pt-1 ml-2">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="card-list">
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="{{route('home')}}/assets/img/jm_denis.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="{{route('home')}}/assets/img/chadengle.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="{{route('home')}}/assets/img/talha.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
                                    ...
                                    <div class="item-list">
                                        <div class="avatar">
                                            <img src="{{route('home')}}/assets/img/mlane.jpg" alt="..."
                                                 class="avatar-img rounded-circle">
                                        </div>
                                        <div class="info-user ml-3">
