...
$head['copyright'] = '';
$seo['title'] = "Clientes | Belão&CIA Manegement System";
?>
    <!DOCTYPE html>
<html lang="pt-BR">
<head>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input value="{{$cliente->nome}}" type="text" id="nome" name="nome" class="form-control" placeholder="Insira o nome do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="telefone">Telefone</label>
                                                <input value="{{$cliente->telefone}}" type="text" id="telefone" name="telefone" class="form-control" placeholder="Insira o telefone do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="documento">CPF/CNPJ</label>
                                                <input value="{{$cliente->doc_identificacao}}" type="text" id="documento" name="doc_identificacao" class="form-control" placeholder="Insira o CPF/CNPF do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="cep">CEP</label>
                                                <input value="{{$cliente->cep}}" type="text" class="form-control" id="cep" name="cep" placeholder="Insira o CEP">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="rua">Rua</label>
                                                <input value="{{$cliente->rua}}" type="text" class="form-control" id="rua" name="rua" placeholder="Insira a rua">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="numero">Número</label>
                                                <input value="{{$cliente->numero}}" type="text" class="form-control" id="numero" name="numero" placeholder="Insira o número">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="complemento">Complemento</label>
                                                <input value="{{$cliente->complemento}}" type="text" class="form-control" id="complemento" name="complemento" placeholder="Insira o complemento">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="bairro">Bairro</label>
                                                <input value="{{$cliente->bairro}}" type="text" class="form-control" id="bairro" name="bairro" placeholder="Insira o bairro">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="cep">Cidade</label>
                                                <input value="{{$cliente->cidade}}" type="text" class="form-control" id="cidade" name="cidade" placeholder="Insira a cidade">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="uf" name="uf">
                                                    ...
                                                    <option {{($cliente->uf == 'AC')?'selected':''}} value="AC">Acre</option>
                                                    <option {{($cliente->uf == 'AL')?'selected':''}} value="AL">Alagoas</option>
                                                    <option {{($cliente->uf == 'AP')?'selected':''}} value="AP">Amapá</option>
                                                    <option {{($cliente->uf == 'AM')?'selected':''}} value="AM">Amazonas</option>
                                                    <option {{($cliente->uf == 'BA')?'selected':''}} value="BA">Bahia</option>
                                                    <option {{($cliente->uf == 'CE')?'selected':''}} value="CE">Ceará</option>
                                                    <option {{($cliente->uf == 'DF')?'selected':''}} value="DF">Distrito Federal</option>
                                                    <option {{($cliente->uf == 'ES')?'selected':''}} value="ES">Espírito Santo</option>
                                                    <option {{($cliente->uf == 'GO')?'selected':''}} value="GO">Goiás</option>
                                                    <option {{($cliente->uf == 'MA')?'selected':''}} value="MA">Maranhão</option>
                                                    <option {{($cliente->uf == 'MT')?'selected':''}} value="MT">Mato Grosso</option>
                                                    <option {{($cliente->uf == 'MS')?'selected':''}} value="MS">Mato Grosso do Sul</option>
                                                    <option {{($cliente->uf == 'MG')?'selected':''}} value="MG">Minas Gerais</option>
                                                    <option {{($cliente->uf == 'PA')?'selected':''}} value="PA">Pará</option>
                                                    <option {{($cliente->uf == 'PB')?'selected':''}} value="PB">Paraíba</option>
                                                    <option {{($cliente->uf == 'PR')?'selected':''}} value="PR">Paraná</option>
                                                    <option {{($cliente->uf == 'PE')?'selected':''}} value="PE">Pernambuco</option>
                                                    <option {{($cliente->uf == 'PI')?'selected':''}} value="PI">Piauí</option>
                                                    <option {{($cliente->uf == 'RJ')?'selected':''}} value="RJ">Rio de Janeiro</option>
                                                    <option {{($cliente->uf == 'RN')?'selected':''}} value="RN">Rio Grande do Norte</option>
                                                    <option {{($cliente->uf == 'RS')?'selected':''}} value="RS">Rio Grande do Sul</option>
                                                    <option {{($cliente->uf == 'RO')?'selected':''}} value="RO">Rondônia</option>
                                                    <option {{($cliente->uf == 'RR')?'selected':''}} value="RR">Roraima</option>
                                                    <option {{($cliente->uf == 'SC')?'selected':''}} value="SC">Santa Catarina</option>
                                                    <option {{($cliente->uf == 'SP')?'selected':''}} value="SP">São Paulo</option>
                                                    <option {{($cliente->uf == 'SE')?'selected':''}} value="SE">Sergipe</option>
                                                    <option {{($cliente->uf == 'TO')?'selected':''}} value="TO">Tocantins</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
...
<script src="{{route('home')}}/js/clientes.js"></script>
