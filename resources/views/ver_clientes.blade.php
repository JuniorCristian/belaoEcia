                                    ...
                                    <table id="datatable" class="display table table-striped table-hover">
                                        ...
                                        <?php $obra = $cliente->obras()->orderBy('created_at','DESC')->first()?>
                                            <tr>
                                                ...
                                                @if(count($cliente->obras()->orderBy('created_at','DESC')) > 0)
                                                ...
                                                <td><a data-csrf="{{csrf_token()}}" data-rota="{{route('clientes.delete', ['cliente'=>$cliente->id])}}" data-id="{{$cliente->id}}" class="deleta"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                        </tbody>
                                        @endforeach
                                    </table>
