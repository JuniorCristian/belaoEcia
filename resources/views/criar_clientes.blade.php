            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item">
                            <a href="{{route('clientes.criar')}}">Criar Cliente</a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nome" name="nome" class="form-control" placeholder="Insira o nome do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="telefone">Telefone</label>
                                                <input type="text" id="telefone" name="telefone" class="form-control" placeholder="Insira o telefone do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
                                                <label for="documento">CPF/CNPJ</label>
                                                <input type="text" id="documento" name="doc_identificacao" class="form-control" placeholder="Insira o CPF/CNPF do cliente">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            <div class="form-group">
